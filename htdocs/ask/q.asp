...
Class Ask_Show_List
		...
		Sub EchoAnswerItem (sTokenName)
		 Select Case lcase(sTokenName)
		    ...
		    case "content" 
			 if KS.IsNul(KS.ASetting(52)) Or KS.FoundInArr(KS.ASetting(52),KSUser.GroupID,",") or Answer(10,i)<>1 Then
