...
Class Ask_Handle
		...
		<form method="post" action="handle.asp?action=saveadd">
		 ...
		 <textarea name="addContent" id="addContent" wrap="PHYSICAL" style="display:none;width:98%;height:100px;padding:4px;"><%=AddText%></textarea>
		 <iframe id="Editor" name="Editor" src="../editor/ubb/askeditor.html?id=addContent" frameBorder="0" marginHeight="0" marginWidth="0" scrolling="No" style="height:215px;width:99%"></iframe>
