...
<%
Const CheckNewVersion=false   '是否检测获得官方最新版本信息
...
Class Admin_Index
		...
		.Write "<div id='ajaxmsg' style='text-align:center;background-color: #ffffee;border: 1px #f9c943 solid;position:absolute; z-index:1; left: 200px; top: 5px;display:none;'> <img src='images/loading.gif'> 请稍候,正在执行您的请求...  </div>"
			...
			.Write "          <tr>"
			.Write "            <td rowspan='2' width='160' style='color:#fff;text-align:center'><span  class='logo'>KesionCMS</span><br/>version V" & GetVersion & "</td>"			
			...
			<div>
			     <ul id="TabPage">
					...
					<li id="left_tab6" <%If Instr(Request.Cookies(KS.SiteSn)("ModelPower"),"user1")<=0 and Request.Cookies(KS.SiteSn)("SuperTF")<>"1" then response.Write(" style='display:none' ") %>onClick="javascript:showleft(6);" title="用户管理">用户</li>
			   ...
			   End If
				...
				<%end if%>
					...
					<div class="dt">版权信息</div>
                       <div class="dc">
					    <li><a href="javascript:void(0)">开发:漳州科兴信息技术有限公司</a></li>
						<li><a href="http://www.kesion.com" target="_blank">官方:kesion.com</a></lI>
						<li><a href="javascript:void(0)">电话:4000080263 0596-2218051</a></li>
						<li><a href="javascript:void(0)">传真:0596-2198252</a></lI>
...
<%
		...
		Sub GetRemoteVer()
         response.write getfile("http://www.ke" & "s"& "ion.com/websystem/Getoffic" & "ialInfo.asp?action=ver")
		End Sub
		Sub CopyRight()
		  ...
		  Else
			  If KS.IsNul(Session("CheckCopyRight")) Then
			   Session("CheckCopyRight")=getfile("http://www.ke" & "s"& "ion.com/websystem/VerifyAuthorization.asp?myurl=" & GetTrueDomain(Request.ServerVariables("SERVER_NAME")))
			  End If
			   
			  If Not KS.IsNul(Session("CheckCopyRight")) and Session("CheckCopyRight")<>"error!" Then
				If Session("CheckCopyRight")="true" Then
				  KS.Echo escape("<span style='color:green;font-weight:bold;font-size:14px'>恭喜，您的网站已经过官方正版授权。有关授权问题<a href='http://www.kesion.com/sysq/sqcx.html' target='_blank'>请点此查询</a></span>。")
				Else
				 If IsBusiness=False Then
				  KS.Echo escape("<span style='color:red;font-weight:bold;font-size:14px'>您当前使用的是免费版本，仅授权个人非商业使用。</span>")
				 Else
				  KS.Echo escape("<span style='color:red;font-weight:bold;font-size:14px'>您当前使用的版本经官方正版验证不通过，仅授权个人非商业使用。有关授权问题<a href='http://www.kesion.com/sysq/sqcx.html' target='_blank'>请点此查询</a> <span style='font-weight:normal;color:#999;font-size:12px'>tips:商业用户请使用授权域名进入后台，此提示将自动消失。</span></span>")
				 End If
				End If
			  End If
		  End If
  ...
  Public Sub KS_Main()
           ...
           <!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
			...
			<script type="text/javascript">
			function showbigpic(){
				var box=$.dialog({title:'查看软件登记证书：',content: '<style>.zs{width:460px;}.zs li img{border:1px solid #000;margin:5px;width:199px;height:220px;}.zs li{width:200px;float:left;margin:10px;}</style><strong>软件版权证书：</strong><br/><div class="zs"><ul><li><a href="http://www.kesion.com/images/cmsv9zs.jpg" target="_blank"><img src="http://www.kesion.com/images/cmsv9zs.jpg"/></a></li><li><a href="http://www.kesion.com/images/eshopv9zs.jpg" target="_blank"><img src="http://www.kesion.com/images/eshopv9zs.jpg"/></a></li><li><a href="http://www.kesion.com/images/examv9zs.jpg" target="_blank"><img src="http://www.kesion.com/images/examv9zs.jpg"/></a></li><li><a href="http://www.kesion.com/images/v5dj.jpg" target="_blank"><img src="http://www.kesion.com/images/v5dj.jpg"/></a></li></ul></div>',max:false,min: false});
			}
			$(document).ready(function(){
			...
			<%
			 ...
			 RS.Open "Select top 1 a.*,b.GroupName From KS_Admin a Inner Join KS_UserGroup B on a.groupid=b.id Where a.UserName='" & KS.C("AdminName") & "'", Conn, 1, 1
			 If Not RS.EOF Then
				KS.Echo "身份：" &  RS("GroupName") & " 登录次数：" & RS("LoginTimes") & "次 本次登录时间：" & RS("LastLoginTime")
			 End If
			 RS.Close: Set RS=Nothing
			%></div>
			<div class="title"><img src="images/gif-0760.gif">版权声明：</div>
			<div class="nr">KesionCMS<sup>TM</sup>系统由漳州科兴信息技术有限公司(<a href="http://www.kesion.com" target="_blank">Kesion.Com</a>)独立开发，软件制作权登记号：<a href="javascript:;" onClick="showbigpic()">2012SR058633</a>。任何个人或组织不得在授权允许的情况下删除、修改、拷贝本软件及其它副本上一切关于版权的信息。<span id="currversion"></span></span>
			</div>
			...
			<div class="nr l">
			 <ul>
			   ...
			   <%if CheckNewVersion then%>
			   <li>最新版本：<span id='versioninfo'><img src='images/loading.gif' align='absmiddle'>loading...</span></li>
			   <%end if%>
			   <li>产品开发：漳州科兴信息技术有限公司</li>
			   <li>咨询 Q Q：9537636 41904294 商业合作QQ：111394 54004407</li>
			   <li>公司网站：<a href='http://www.kesion.com/' target='_blank'>kesion.com</a> <a href='http://www.kesion.org/' target='_blank'>kesion.org</a> <a href='http://www.kesion.net/' target='_blank'>kesion.net</a></li>
			  </ul>
			  </div>
			  <%If CheckNewVersion then%>
			 <div class="nr r">
			...
			If KS.C_S(6,21)="1" Then
			 ...
			 If Num>0 Then
			  HasVerify=true
		      KS.Echo " <span style='cursor:pointer;' title='点击进入订单管理' onclick=""location.href='KS.ShopOrder.asp';$(parent.document).find('#BottomFrame')[0].src='KS.Split.asp?ButtonSymbol=Disabled&opstr=" & server.URLEncode("商城系统 >> <font color=red>所理所有订单</font>")&"';"">待确认订单[<font color=red>" & Num & "</font>]个</span>"
			 End If
			End If
			...
			<div class="nr">
			 <ul class="bbs"><script charset="gb2312" id="showtopic" src="http://bbs.kesion.com/Dv_News.asp?GetName=newtopic"></script>
			  </ul>
			</div>
			</div>
          ...
          <%
			...
			Public Sub KS_Foot()
		     With Response
			    ...
			    End If
				.Write "</div>"
				.Write "<div id='footcopyright'>版权所有 &copy; 2006-2012 科兴信息技术有限公司</div>"
				.Write "</div>"
				.Write "<SCRIPT language=javascript>"
