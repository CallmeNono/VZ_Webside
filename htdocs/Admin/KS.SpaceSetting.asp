...
Class Admin_System
		...
		With Response
			...
			.Write "    </tr>"
			 ...
			 .Write "  <td height=""30"">"
			 .Write " <input type=""text"" class='textbox' name=""Setting(15)"" size=15 value=""" & Setting(15) & """> <font color=blue>如:space.kesion.com</font>"
			 ...
			 .Write "  <td height=""30"">"
			 .Write " <input  type=""text"" class='textbox' name=""Setting(16)"" size=15 value=""" & Setting(16) & """> <font color=blue>如:三级域名:space.kesion.com或二级域名kesion.com</font>"
 ...
 .Write "   <tr valign=""middle"" class=""tdbg"" onMouseOver=""this.className='tdbgmouseover'"" onMouseOut=""this.className='tdbg'"">"
			...
			.Write "<div style=""height:30px;text-align:center"">KeSion CMS V "& GetVersion &", Copyright (c) 2006-2012 <a href=""http://www.kesion.com/"" target=""_blank""><font color=#ff6600>KeSion.Com</font></a>. All Rights Reserved . </div>"
