...
Class Admin_UserGroup
       ...
       Sub Kesion()
		...
		Action=Trim(request("Action"))
			...
			response.Write "<div style=""height:30px;text-align:center"">KeSion CMS V " & GetVersion &", Copyright (c) 2006-2012 <a href=""http://www.kesion.com/"" target=""_blank""><font color=#ff6600>KeSion.Com</font></a>. All Rights Reserved . </div>"
		End Sub
