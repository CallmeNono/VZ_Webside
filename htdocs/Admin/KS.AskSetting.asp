...
Class Admin_Ask_Setting
		...
		With Response
			...
			.Write "<div style=""clear:both;text-align:center;color:#003300"">--------------------------------------------------------------------------------<br/>KeSion CMS V " & GetVersion & ", Copyright (c) 2006-2012 <a href=""http://www.kesion.com/"" target=""_blank"">KeSion.Com</a>. All Rights Reserved . </div>"
