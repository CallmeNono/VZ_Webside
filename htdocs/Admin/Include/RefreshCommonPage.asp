...
Class RefreshCommonPage
		...
		Response.Write "<div style=""height:30px;text-align:center"">KeSion CMS V 8.0, Copyright (c) 2006-2010 <a href=http://www.kesion.com/ target=""_blank""><font color=#cc6600>KeSion.Com</font></a>. All Rights Reserved . </div>"
		Response.Write "</body>"
		Response.Write "</html>"
		End Sub
End Class
