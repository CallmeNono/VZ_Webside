		   ...
		   '**************************************************
			...
			Function UserAutoUpdateGroup(UserName)
			  ...
			  If UpdateGroupID<>0 Then
				...
				Dim MailContent:MailContent="尊敬的会员" & UserName&"!<br/>&nbsp;&nbsp;&nbsp;&nbsp;您在本站商城中心累计消费<font color=red>" & GetConsumMoney(UserName) & "</font> 元，已达到升级为“" & KS.GetUserGroupName(UpdateGroupID) & "”会员级别的权利，恭喜您已成功升级到该用户级别。您可以<a href=user_rank.asp><u>点此</u></a>查看相关会员级别权利！"
