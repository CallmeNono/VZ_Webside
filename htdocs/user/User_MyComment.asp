...
Class MyComment
		...
		<div class="tabs">						  
			<ul>
				<li<%If flag=0 then response.write " class='puton'"%>><a href="User_MyComment.asp">我参与的评论(<span class="red"><%=Conn.Execute("Select count(id) from KS_Comment" & Param & "")(0)%></span>)</a></li>
 ...
 Sub GetWriteComment(ID,Page)
		...
		With KS
		 ...
		 Else
			 ...
			 .echo "   &nbsp;&nbsp;<input name=""AnounName"" type=""text"" readonly id=""AnounName"" value=""" & RS("UserName") & """ style=""width:55%""/>"
			 .echo "   </td>"
			 .echo "  </tr>"
			 .echo "  <tr class=""tdbg"">"
