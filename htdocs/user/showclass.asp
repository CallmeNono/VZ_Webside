...
document.getElementById('smallerclassid').options[0] = new Option('请选择...','0');

document.getElementById('smallclassid').length = 0;
document.getElementById('smallclassid').options[0] = new Option('请选择...','0');
...
document.write ("<select class='select' name='bigclassid' modified='false' id='bigclassid' style='width:120px' size='1' onChange='changesmallclassid(this.value)'>");
...
document.write ("  <select class='select' modified='false' name='smallclassid' size='1' onChange='changesmallerclassid(this.value)' style='width:120px;display:none' id='smallclassid'>");
document.write ("<option value='0' selected>请选择...</option>");
document.write ("</select>")
document.write ("  <select class='select' modified='false' name='smallerclassid' size='1' style='display:none;width:120px' id='smallerclassid' onChange='getclassid(this.value)'>");
document.write ("<option value='0' selected>请选择...</option>");
document.write ("</select>");
